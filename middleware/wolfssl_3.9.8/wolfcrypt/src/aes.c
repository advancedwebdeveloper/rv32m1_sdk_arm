...
#if !(defined(FREESCALE_AES_CBC_ALT) || defined(FREESCALE_AES_ALT))
...
#endif /* FREESCALE_AES_CBC_ALT || FREESCALE_AES_ALT */
...
/* wc_AesSetKey */
#if !defined(FREESCALE_AES_SETKEY_ALT)
...
#endif /* FREESCALE_AES_SETKEY_ALT */
...
#endif /* FREESCALE_AES_ALT */
#endif /* WOLFSSL_AES_DIRECT */


/* AES-CBC */
#if !defined(FREESCALE_AES_CBC_ALT)
#ifdef HAVE_AES_CBC
#ifdef STM32F2_CRYPTO
    int wc_AesCbcEncrypt(Aes* aes, byte* out, const byte* in, word32 sz)
    {
...
#endif /* HAVE_AES_CBC */
#endif /* FREESCALE_AES_CBC_ALT */

/* AES-CTR */
#ifdef WOLFSSL_AES_COUNTER
#if !defined(FREESCALE_AES_CTR_ALT)
...
#if !defined(FREESCALE_AES_GCM_ALT)
enum {
    NONCE_SZ = 12,
    CTR_SZ   = 4
};
...
#if !defined(FREESCALE_AES_CCM_ALT)
void wc_AesCcmSetKey(Aes* aes, const byte* key, word32 keySz)
{
