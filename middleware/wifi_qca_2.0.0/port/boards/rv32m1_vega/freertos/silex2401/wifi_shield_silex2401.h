...
/* WLAN_IRQ signal */
#define WIFISHIELD_WLAN_IRQn (PORTA_IRQn)
#define WIFISHIELD_WLAN_ISR PORTA_IRQHandler
#define WIFISHIELD_WLAN_IRQ_DIRECTION (kGPIO_DigitalInput)
#define WIFISHIELD_WLAN_IRQ_PORT (PORTA)
#define WIFISHIELD_WLAN_IRQ_GPIO (GPIOA)
#define WIFISHIELD_WLAN_IRQ_PIN (27)
...
#define WIFISHIELD_WLAN_PWRON_PIN (14)
