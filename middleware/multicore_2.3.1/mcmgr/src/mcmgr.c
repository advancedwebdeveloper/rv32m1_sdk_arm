...
void MCMGR_StartupDataEventHandler(uint16_t startupDataChunk, void *context)
{
...
void MCMGR_FeedStartupDataEventHandler(uint16_t startupDataChunk, void *context)
{
    mcmgr_core_context_t *coreContext = (mcmgr_core_context_t *)context;
