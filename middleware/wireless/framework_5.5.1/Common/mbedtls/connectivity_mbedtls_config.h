...
#define MBEDTLS_SSL_MAX_CONTENT_LEN (768) /* Reduce SSL frame buffer. */
...
extern void* MEM_CallocAlt (size_t len, size_t val);
extern void MEM_FreeAlt (void *pData);
#define MBEDTLS_PLATFORM_STD_CALLOC   MEM_CallocAlt /**< Default allocator to use, can be undefined */
#define MBEDTLS_PLATFORM_STD_FREE       MEM_FreeAlt /**< Default free to use, can be undefined */
