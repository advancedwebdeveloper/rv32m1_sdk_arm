...
typedef struct hciLeSetAdvertisingEnableCommand_tag
{
    hciLeAdvertisingEnable_t    advertisingEnable;
} hciLeSetAdvertisingEnableCommand_t;
...
typedef struct hciLePhyUpdateCompleteEvent_tag
{
    hciErrorCode_t              status;
    uint16_t                    connectionHandle;
    uint8_t                     txPhy;
...
/*! OCF 0x0030 */
/*! HCI_LE_Read_Phy */
typedef struct hciLeReadPhyCommand_tag
{
    uint16_t            connectionHandle;
...
typedef struct hciLeSetDefaultPhyCommand_tag
{
    uint8_t             allPhys;
    uint8_t             txPhys;
    uint8_t             rxPhys;
...
/*! OCF 0x0032 */
/*! HCI_LE_Set_Phy */
typedef struct hciLeSetPhyCommand_tag
{
    uint16_t            connectionHandle;
    uint8_t             allPhys;
    uint8_t             txPhys;
...
typedef struct hciLeEnhancedReceiverTestCommand_tag
{
    uint8_t             rxChannel;
    uint8_t             phy;
...
typedef struct hciLeEnhancedTransmitterTestCommand_tag
{
    uint8_t             txChannel;
    uint8_t             dataLen;
    uint8_t             payloadType;
...
typedef struct hciSetTxPowerLevelCommand_tag
{
    uint8_t                       powerLevel;
    bleTransmitPowerChannelType_t channelType;
} hciSetTxPowerLevelCommand_t;

typedef struct hciSetTxPowerLevelCommandComplete_tag
{
    hciErrorCode_t                status;
...
typedef struct hciLeSetAdvertisingEnableCommandComplete_tag
{
    hciErrorCode_t              status;
...
typedef struct hciLeReadPhyCommandComplete_tag
{
    hciErrorCode_t      status;
    uint16_t            connectionHandle;
    uint8_t             txPhy;
...
typedef struct hciCommand_tag
{
    ...
    union
    {
     ...
     /* hciLeReadAdvertisingChannelTxPowerCommand_t     hciLeReadAdvertisingChannelTxPowerCmd; */  // No parameters
        ...
        hciLeSetAdvertisingEnableCommand_t              hciLeSetAdvertisingEnableCmd;
...
bleResult_t Hci_LeSetAdvertisingEnable(void);                                                   /* 8.9 */
bleResult_t Hci_LeSetAdvertisingDisable(void);                                                  /* 8.9 */
...
bleResult_t Hci_VendorSpecificSetTxPowerLevel(hciSetTxPowerLevelCommand_t *pParam);
...
bleResult_t Hci_LeReadPhy(hciLeReadPhyCommand_t *pParam);                                       /* 8.47 */
bleResult_t Hci_LeSetDefaultPhy(hciLeSetDefaultPhyCommand_t *pParam);                           /* 8.48 */
bleResult_t Hci_LeSetPhy(hciLeSetPhyCommand_t *pParam);                                         /* 8.49 */
bleResult_t Hci_LeEnhancedReceiverTest(hciLeEnhancedReceiverTestCommand_t *pParam);             /* 8.50 */
bleResult_t Hci_LeEnhancedTransmitterTest(hciLeEnhancedTransmitterTestCommand_t *pParam);       /* 8.51 */
