...
#define gHciLeSetAdvertisingEnable_c            0x000A
...
#define gHciLeReadPhy_c                             0x0030
#define gHciLeSetDefaultPhy_c                       0x0031
#define gHciLeSetPhy_c                              0x0032
#define gHciLeEnhancedReceiverTest_c                0x0033
#define gHciLeEnhancedTransmitterTest_c             0x0034

     /*! HCI OGF : 0x3F : Vendor Specific Debug Commands */
#define gHciVendorSpecificDebugCommands_c               0x03F
#define gHciSetTxPowerCommand_c                     0x012D
...
#define gHciAddrTypePrivacyOffset_c      (0x02)
#define gHciFilterPolicyPrivacyOffset_c  (0x02)
...
typedef enum
{
    ...
    gHciSuppCommShiftLeSetAdvertisingEnable_c                        = 26 * 8 + 1,
...
typedef enum {
    gHciBleAddrTypePublic_c            = 0x00,     /*!< Public Device Address - fixed into the Controller by the manufacturer. */
    gHciBleAddrTypeRandom_c            = 0x01,     /*!< Random Device Address - set by the Host into the Controller for privacy reasons. */
#if (gBLE42_d == TRUE)
    gHciBleAddrTypePublicIdentity_c    = 0x02,     /*!< Public Identity Address - corresponds to Resolvable Private Address. */
    gHciBleAddrTypeRandomIdentity_c    = 0x03      /*!< Random (static) Identity Address - corresponds to Resolvable Private Address. */
#endif
} hciBleAddressType_t;
