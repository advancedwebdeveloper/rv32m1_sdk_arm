...
typedef enum {
    gGattProcExchangeMtu_c                          = 0x00, /*!< MTU Exchange */
    gGattProcDiscoverAllPrimaryServices_c           = 0x01, /*!< Primary Service Discovery */
    gGattProcDiscoverPrimaryServicesByUuid_c        = 0x02, /*!< Discovery of Services by UUID */
    gGattProcFindIncludedServices_c                 = 0x03, /*!< Discovery of Included Services within a Service range */
    gGattProcDiscoverAllCharacteristics_c           = 0x04, /*!< Characteristic Discovery within Service range */
    gGattProcDiscoverCharacteristicByUuid_c         = 0x05, /*!< Characteristic Discovery by UUID */
    gGattProcDiscoverAllCharacteristicDescriptors_c = 0x06, /*!< Characteristic Descriptor Discovery */
    gGattProcReadCharacteristicValue_c              = 0x07, /*!< Characteristic Reading using Value handle */
    gGattProcReadUsingCharacteristicUuid_c          = 0x08, /*!< Characteristic Reading by UUID */
    gGattProcReadMultipleCharacteristicValues_c     = 0x09, /*!< Reading multiple Characteristics at once */
    gGattProcWriteCharacteristicValue_c             = 0x0A, /*!< Characteristic Writing */
    gGattProcReadCharacteristicDescriptor_c         = 0x0B, /*!< Reading Characteristic Descriptors */
    gGattProcWriteCharacteristicDescriptor_c        = 0x0C, /*!< Writing Characteristic Descriptors */
} gattProcedureType_t;
