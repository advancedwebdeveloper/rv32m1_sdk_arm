...
* \param txPhys        Host preferences on Tx Phy, as defined by gapLeTxPhyFlags_t, ignored for gLeTxPhyNoPreference_c
* \param rxPhys        Host preferences on Rx Phy, as defined by gapLeRxPhyFlags_t, ignored for gLeRxPhyNoPreference_c
