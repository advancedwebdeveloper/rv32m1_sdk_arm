...
typedef enum
{
    gTxPowerAdvChannel_c         = 0x00, /*!< Advertising channel type when setting Tx Power. */
    gTxPowerConnChannel_c        = 0x01, /*!< Connection channel type when setting Tx Power. */
...
typedef enum gapLeAllPhyFlags_t {
...
/*! Le Tx Phys Preferences flags. */
typedef enum gapLeTxPhyFlags_t {
    gLeTxPhy1MFlag_c        = BIT0,         /*!< Host prefers to use LE 1M Tx Phy, possibly among others */
    gLeTxPhy2MFlag_c        = BIT1,         /*!< Host prefers to use LE 2M Tx Phy, possibly among others */
    gLeTxPhyCodedFlag_c     = BIT2,         /*!< Host prefers to use LE Coded Tx Phy, possibly among others */
} gapLeTxPhyFlags_t;

/*! Le Rx Phys Preferences flags. */
typedef enum gapLeRxPhyFlags_t {
    gLeRxPhy1MFlag_c        = BIT0,         /*!< Host prefers to use LE 1M Rx Phy, possibly among others */
    gLeRxPhy2MFlag_c        = BIT1,         /*!< Host prefers to use LE 2M Rx Phy, possibly among others */
    gLeRxPhyCodedFlag_c     = BIT2,         /*!< Host prefers to use LE Coded Rx Phy, possibly among others */
} gapLeRxPhyFlags_t;

/*! Le Phys Options Preferences flags. */
typedef enum gapLePhyOptionsFlags_t {
    gLeCodingNoPreference_c = 0x00,         /*!< Host has no preference on the LE Coded Phy */
    gLeCodingS2_c           = 0x01,         /*!< Host prefers to use S=2 on the LE Coded Phy */
    gLeCodingS8_c           = 0x02,         /*!< Host prefers to use S=8 on the LE Coded Phy */
} gapLePhyOptionsFlags_t;
  
/*! Le Tx Phys. */
typedef enum gapLeTxPhy_tag {
    gLeTxPhy1M_c            = 0x01,         /*!< Tx Phy on the connection is LE 1M */
    gLeTxPhy2M_c            = 0x02,         /*!< Tx Phy on the connection is LE 2M */
    gLeTxPhyCoded_c         = 0x03,         /*!< Tx Phy on the connection is LE Coded */
} gapLeTxPhy_t;

/*! Le Rx Phys. */
typedef enum gapLeRxPhy_tag {
    gLeRxPhy1M_c            = 0x01,         /*!< Rx Phy on the connection is LE 1M */
    gLeRxPhy2M_c            = 0x02,         /*!< Rx Phy on the connection is LE 2M */
    gLeRxPhyCoded_c         = 0x03,         /*!< Rx Phy on the connection is LE Coded */
} gapLeRxPhy_t;

/*! Phy Event Type */
typedef enum gapPhyEventType_tag
{
    gPhySetDefaultComplete_c,               /*!< Gap_LeSetPhy default mode was successful */
    gPhyRead_c,                             /*!< Gap_LeReadPhy return values */
    gPhyUpdateComplete_c,                   /*!< Gap_LeSetPhy return values for a connection or an update occured */
} gapPhyEventType_t;

/*! Phy Event */
typedef struct gapPhyEvent_tag {
