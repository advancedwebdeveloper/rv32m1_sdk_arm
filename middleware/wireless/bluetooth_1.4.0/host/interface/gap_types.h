...
typedef enum gapSecurityLevel_tag {
    ...
    gSecurityLevel_LeSecureConnections_c =  0x03   /*!< Authenticated with LE Secure Connections. */
} gapSecurityLevel_t;
...
typedef enum gapAdType_tag {
    ...
    gAdUniformResourceIdentifier_c           = 0x24,    /*!< Defined by the Bluetooth SIG. */
    gAdLeSupportedFeatures_c                 = 0x27,    /*!< Defined by the Bluetooth SIG. */
    gAdChannelMapUpdateIndication_c          = 0x28,    /*!< Defined by the Bluetooth SIG. */
...
/*! Values of the AD Security Manager OOB advertising data structure. */
typedef enum gapAdTypeSecuirtyManagerOobFlags_tag {
    gNoSmOobFlags_c                             = 0x00,     /*!< No Security Manager OOB Flags set. */
    gSmOobDataPresent_c                         = BIT0,     /*!< 0 = OOB data not present, 1 = OOB data present */
    gLeSupportedHost_c                          = BIT1,     /*!< LE supported (Host) - bit 65 of LMP Extended Feature bits Page 1 */
    gSimultaneousLeAndBrEdrCapableHost_c        = BIT2,     /*!< Host supports simultaneous Le and BR/EDR */
    gAddressType_c                              = BIT3,     /*!< 0 = Public Address, 1 = Random Address */
} gapAdTypeSecuirtyManagerOobFlags_t;

/*! LE Bluetooth Device Addres advertising data structure. */
typedef PACKED_STRUCT gapAdSlaveConnectionIntervalRange_tag
{
    uint16_t    connIntervalMin;    /*!< (0x0006 to 0x0C80) * [1.25ms] */
    uint16_t    connIntervalMax;    /*!< (0x0006 to 0x0C80) * [1.25ms] */
} gapAdSlaveConnectionIntervalRange_t;

/*! Slave Connection Interval Range advertising data structure. */
typedef struct gapAdLeBluetoothDeviceAddress_tag
{
    uint8_t     leDeviceAddress[gcBleDeviceAddressSize_c];  /*!< Size of the address is 6 octets */
    uint8_t     leDeviceAddressType;                        /*!< \ref bleAddressType_t */
} gapAdLeBluetoothDeviceAddress_t;

/*! Values of the AD LE Role advertising data structure. */
typedef enum gapAdTypeLeRole_tag {
    gLeOnlyPeripheralModeSupported_c            = 0x00,     /*!< Only Peripheral Role supported */
    gLeOnlyCentralModeSupported_c               = 0x01,     /*!< Only Central Role supported */
    gLeCentralAndPeripheralPreferred_c          = 0x02,     /*!< Peripheral and Central Role supported, Peripheral preferred */
    gLeCentralPreferredAndPeripheral_c          = 0x03,     /*!< Peripheral and Central Role supported, Central preferred */
} gapAdTypeLeRole_t;

/*! Channel Map Update Indication advertising data structure. */
typedef struct gapAdChannelMapUpdateIndication_tag
{
    uint8_t     channelMap[4];  /*!< Channel Map */
    uint8_t     instant[2];     /*!< Instant of update - connection event count*/
} gapAdChannelMapUpdateIndication_tag;
...
typedef enum gapConnectionEventType_tag {
    gConnEvtConnected_c                 = 0x00, /*!< A connection has been established. Data in gapConnectionEvent_t.eventData.connectedEvent. */
    gConnEvtPairingRequest_c            = 0x01, /*!< A pairing request has been received from the peer Master. Data in gapConnectionEvent_t.eventData.pairingEvent. */
    gConnEvtSlaveSecurityRequest_c      = 0x02, /*!< A Slave Security Request has been received from the peer Slave. Data in gapConnectionEvent_t.eventData.slaveSecurityRequestEvent. */
    gConnEvtPairingResponse_c           = 0x03, /*!< A pairing response has been received from the peer Slave. Data in gapConnectionEvent_t.eventData.pairingEvent. */
    gConnEvtAuthenticationRejected_c    = 0x04, /*!< A link encryption or pairing request has been rejected by the peer device. Data in gapConnectionEvent_t.eventData.authenticationRejectedEvent. */
    gConnEvtPasskeyRequest_c            = 0x05, /*!< Peer Slave has requested a passkey (maximum 6 digit PIN) for the pairing procedure. Master should respond with Gap_EnterPasskey. Slave will not receive this event! Slave's application must call Gap_SetLocalPasskey before any connection. */
    gConnEvtOobRequest_c                = 0x06, /*!< Out-of-Band data must be provided for the pairing procedure. Master or Slave should respond with Gap_ProvideOob. */
    gConnEvtPasskeyDisplay_c            = 0x07, /*!< The pairing procedure requires this Slave to display the passkey for the Master's user. */
    gConnEvtKeyExchangeRequest_c        = 0x08, /*!< The pairing procedure requires the SMP keys to be distributed to the peer. Data in gapConnectionEvent_t.eventData.keyExchangeRequestEvent. */
    gConnEvtKeysReceived_c              = 0x09, /*!< SMP keys distributed by the peer during pairing have been received. Data in gapConnectionEvent_t.eventData.keysReceivedEvent. */
    gConnEvtLongTermKeyRequest_c        = 0x0A, /*!< The bonded peer Master has requested link encryption and the LTK must be provided. Slave should respond with Gap_ProvideLongTermKey. Data in gapConnectionEvent_t.eventData.longTermKeyRequestEvent. */
    gConnEvtEncryptionChanged_c         = 0x0B, /*!< Link's encryption state has changed, e.g., during pairing or after a reconnection with a bonded peer. Data in gapConnectionEvent_t.eventData.encryptionChangedEvent. */
    gConnEvtPairingComplete_c           = 0x0C, /*!< Pairing procedure is complete, either successfully or with failure. Data in gapConnectionEvent_t.eventData.pairingCompleteEvent. */
    gConnEvtDisconnected_c              = 0x0D, /*!< A connection has been terminated. Data in gapConnectionEvent_t.eventData.disconnectedEvent. */
    gConnEvtRssiRead_c                  = 0x0E, /*!< RSSI for an active connection has been read. Data in gapConnectionEvent_t.eventData.rssi_dBm. */
    gConnEvtTxPowerLevelRead_c          = 0x0F, /*!< TX power level for an active connection has been read. Data in gapConnectionEvent_t.eventData.txPowerLevel_dBm. */
    gConnEvtPowerReadFailure_c          = 0x10, /*!< Power reading could not be performed. Data in gapConnectionEvent_t.eventData.failReason. */
    gConnEvtParameterUpdateRequest_c    = 0x11, /*!< A connection parameter update request has been received. Data in gapConnectionEvent_t.eventData.connectionUpdateRequest. */
    gConnEvtParameterUpdateComplete_c   = 0x12, /*!< The connection has new parameters. Data in gapConnectionEvent_t.eventData.connectionUpdateComplete. */      
    gConnEvtLeDataLengthChanged_c       = 0x13, /*!< The new TX/RX Data Length paramaters. Data in gapConnectionEvent_t.eventData.rssi_dBm.leDataLengthChanged. */
    gConnEvtLeScOobDataRequest_c        = 0x14, /*!< Event sent to request LE SC OOB Data (r, Cr and Addr) received from a peer. */
    gConnEvtLeScDisplayNumericValue_c   = 0x15, /*!< Event sent to display and confirm a Numeric Comparison Value when using the LE SC Numeric Comparison pairing method. */
    gConnEvtLeScKeypressNotification_c  = 0x16, /*!< Remote Keypress Notification recieved during Passkey Entry Pairing Method. */
...
typedef enum gapCarSupport_tag
{
